...
| 2 | **Planejar** | `plan-architect` | `plan.md` + Constitution Check + ADR |
| 3 | **Fatiar** | (plan) | `tasks.md` por fronteira |
| 4 | **Implementar** | `dev-implementer` | código + testes (diffs pequenos) |
...
- **Reversibilidade** — backup, dry-run e rollback tornam o erro barato; gate proporcional
  ao risco.
- **Toolkit (meta-agentes)** — `agent-designer`, `skill-author`, `research-curator`,
  `didactics-editor` constroem e evoluem o próprio método.
