...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 026) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01–06 ✅ · 13 ✅ (piloto) · 07–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022–026 e seguintes | 🔄 7/13 |
