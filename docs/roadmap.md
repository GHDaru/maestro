...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 025) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01–05 ✅ · 13 ✅ (piloto) · 06–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022–025 e seguintes | 🔄 6/13 |
