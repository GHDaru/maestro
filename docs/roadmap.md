...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 031) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01–11 ✅ · 13 ✅ (piloto) · 12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022–031 e seguintes | 🔄 12/13 |
