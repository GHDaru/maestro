...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 028) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01–08 ✅ · 13 ✅ (piloto) · 09–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022–028 e seguintes | 🔄 9/13 |
