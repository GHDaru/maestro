...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 027) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01–07 ✅ · 13 ✅ (piloto) · 08–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022–027 e seguintes | 🔄 8/13 |
