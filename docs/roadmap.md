...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 030) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01–10 ✅ · 13 ✅ (piloto) · 11–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022–030 e seguintes | 🔄 11/13 |
