...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 022) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01 ✅ · 02 ✅ · 13 ✅ (piloto) · 03–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022 e seguintes | 🔄 3/13 |
