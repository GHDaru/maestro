...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 023) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01 ✅ · 02 ✅ · 03 ✅ · 13 ✅ (piloto) · 04–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022, 023 e seguintes | 🔄 4/13 |
