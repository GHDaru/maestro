...
>
> **Status**: Ativo · **Atualizado**: 2026-08-02 (ciclo 029) · **Regra**: este mapa é
...
| **(contínuo) — Migração didática** | capítulos ao padrão v2, **um por ciclo**: 01–09 ✅ · 13 ✅ (piloto) · 10–12 ⏳ — contagem por `scripts/verificar-capitulos.sh` | 016, 022–029 e seguintes | 🔄 10/13 |
