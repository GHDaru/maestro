...
|---|---|---|---|---|
| Guardião de Processo | `perfis.md` | [`process-guardian`](../../.claude/agents/process-guardian.md) | Read, Grep, Glob | ✅ |
| Spec-agent | `perfis.md` | [`spec-agent`](../../.claude/agents/spec-agent.md) | Read, Write, Grep, Glob | — |
| Plan / Arquiteto | `perfis.md` | [`plan-architect`](../../.claude/agents/plan-architect.md) | Read, Write, Grep, Glob, WebFetch | — |
| Dev / Implementador | `perfis.md` | [`dev-implementer`](../../.claude/agents/dev-implementer.md) | Read, Write, Edit, Bash | — |
...
| UX / Semântica | `perfis.md` | [`ux-semantics`](../../.claude/agents/ux-semantics.md) | Read, Write, Grep, Glob | — |
...
| Curador / Pesquisa | [`research-curator`](../../.claude/agents/research-curator.md) | Read, Write, WebSearch, WebFetch |
| Didática / Editor | [`didactics-editor`](../../.claude/agents/didactics-editor.md) | Read, Write, Edit, Grep |
